      ...
      <PostComponent class="mt-5">
        <div slot="posting">
          ...
          <div class="d-flex" style="height:300px;">
            ...
            <div ref="map" class="h-100 flex-container border-left" style="flex:5">
              지도
            </div>
          </div>
        </div>
            ...
            <div v-if="!files.length" class="room-file-upload-example-container">
              <div class="room-file-upload-example">
                ...
                <div class="room-file-notice-item">
                  실 사진 최소 3장 이상 등록하셔야 하며, 가로 사진을 권장합니다.
                </div>
...
export default {
  ...
  methods:{
    getAddress(){
      // a95de7eb3a79a693df982c380f431c6b
      // https://t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js
      new daum.Postcode({
        oncomplete:(data) => {
          let mapOption = {
            center: new daum.maps.LatLng(37.537187, 127.005476), // 중심 좌표
            level: 6, // 지도 확대 레벨
          }

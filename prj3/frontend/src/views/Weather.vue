...
export default {
    data(){
        return {
            address:[
                ...
                {name: "충청북도", latitude:36.98460, longitude:128.365431},
    ...
    // 9d5286340057ca531804abe16cea5454 : weather api key
    // api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid=9d5286340057ca531804abe16cea5454
    methods:{
    ...
    async mounted(){
        const responseData = await Promise.all(
            this.address.map(li => {
                return axios.get(`http://api.openweathermap.org/data/2.5/weather?lat=${li.latitude}&lon=${li.longitude}&appid=9d5286340057ca531804abe16cea5454`)
            })
        );
        ...
        if(window.kakao && window.kakao.maps){
            ...
            script.src = "http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=68d025427ac366f4a68a037b8cc7c903";
